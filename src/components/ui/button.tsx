...
const buttonVariants = cva(
  "group/button relative inline-flex shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-[1rem] border border-transparent bg-clip-padding text-sm font-medium text-center transition-[color,background-color,border-color,box-shadow,transform,opacity] duration-200 outline-none select-none focus-visible:ring-3 focus-visible:ring-ring/45 focus-visible:ring-offset-2 focus-visible:ring-offset-background active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:translate-y-0 disabled:opacity-55 disabled:saturate-50 motion-reduce:transition-none motion-reduce:transform-none aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg]:transition-transform [&_svg]:duration-200 motion-reduce:[&_svg]:transition-none [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground shadow-[var(--interaction-shadow)] hover:-translate-y-0.5 hover:bg-[color-mix(in_oklab,var(--color-primary)_92%,white)] hover:shadow-[var(--interaction-shadow-strong)] focus-visible:border-primary/30',
        outline:
          'border-border/90 bg-secondary/70 text-secondary-foreground shadow-[0_1px_0_rgba(116,74,38,0.06)] hover:-translate-y-0.5 hover:border-primary/20 hover:bg-accent/70 hover:text-foreground hover:shadow-[var(--interaction-shadow)] aria-expanded:border-primary/20 aria-expanded:bg-accent/70 aria-expanded:text-foreground dark:border-input dark:bg-input/30 dark:hover:bg-input/50',
        secondary:
          'bg-accent text-accent-foreground shadow-[0_1px_0_rgba(116,74,38,0.06)] hover:-translate-y-0.5 hover:bg-[color-mix(in_oklab,var(--color-accent)_84%,white)] hover:shadow-[var(--interaction-shadow)] aria-expanded:bg-accent aria-expanded:text-accent-foreground',
        ghost:
      ...
      size: {
        ...
        'icon-xs': "size-7 rounded-full in-data-[slot=button-group]:rounded-md [&_svg:not([class*='size-'])]:size-3",

...
const iconButtonVariants = cva(
  'group/icon-button inline-flex items-center justify-center rounded-full border border-transparent text-foreground transition-[background-color,border-color,color,box-shadow,transform] duration-200 outline-none focus-visible:ring-3 focus-visible:ring-ring/45 active:translate-y-px motion-reduce:transition-none motion-reduce:transform-none [&_svg]:shrink-0',
  {
    variants: {
      tone: {
        default:
          'bg-secondary/75 text-secondary-foreground shadow-[0_1px_0_rgba(116,74,38,0.08)] hover:border-primary/15 hover:bg-accent hover:text-foreground hover:shadow-[0_10px_24px_rgba(116,74,38,0.12)]',
...
const interactiveCardClassName =
  'group/card relative overflow-hidden rounded-[1.35rem] border border-border/90 bg-card/96 transition-[border-color,background-color,box-shadow,transform] duration-250 hover:-translate-y-0.5 hover:border-primary/25 hover:bg-card hover:shadow-[0_18px_42px_rgba(92,60,35,0.12)] focus-within:-translate-y-0.5 focus-within:border-primary/30 focus-within:shadow-[0_18px_42px_rgba(92,60,35,0.12)] motion-reduce:transition-none motion-reduce:transform-none'
